...
if ($bresult->num_rows > 0) {
     $row3 = $bresult->fetch_assoc();
                echo "<strong>Blood Bank Name</strong> " .$row3["bloodbank_name"]
                ."<br></br>";
                echo "<strong>Contact</strong> ".$row3["bloodbank_contact_no"].
                "<br></br>";
                echo "<strong>Address</strong> "." House No: ".  $row3["house_no"]. " Road No: ".  $row3["road_no"]. " Street: ".  $row3["street"]. " City: ".  $row3["city"].
                "<br></br>";
                echo "<strong>Incharge Name</strong> " .$row3["bloodbank_incharge"]
                ."<br></br>";
