...
$nameErr = $usernameErr = $emailErr = $passwordErr = $genderErr = $ageErr = $bloodgroupErr = $weightErr = $heightErr = $pastdonationErr = $bpErr = $houseErr = $roadErr = $streetErr = $cityErr = $areaCodeErr = $contactErr = $imageErr = "";
$name  = $username = $email = $password = $gender = $age = $bloodgroup = $weight = $height = $pastdonation = $medication = $bp = $house = $road = $street = $city = $areaCode = $contact = $path = "";
$valid = true;
$image_upload = $disease_error = false;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["age"])) {
   ...
   if (empty($_POST["pastdonation"])) {
     $pastdonationErr = "Previous donation information is required";
     $valid = false;
   } else {
     $pastdonation = test_input($_POST["pastdonation"]);
   }
  ...
  }else
  {
   ...
   //Disease Checking
   if (isset($_POST['acute_infection'])) {
      $disease_error= true;
  } 
  ...
  if (isset($_POST['chronic_illnesses'])) {
      $disease_error= true;
  } 
  if (isset($_POST['cjd'])) {
      $disease_error= true;
  ...
  if (isset($_POST['hemochromatosis'])) {
      $disease_error= true;
  } 
  if (isset($_POST['hepatities'])) {
      $disease_error= true;
  }
  if (isset($_POST['aids'])) {
      $disease_error= true;
  ...
  if (isset($_POST['tuberculosis'])) {
   ...
   if($valid){
    if($disease_error === true){
        header('Location: register.php?hasDisease=true');
    }
  ...
  try {
    ...
    $conn->exec($sql);
    $sql = "INSERT INTO donor (donor_id, donor_name, donor_gender, donor_age, donor_bloodgroup, donor_height, donor_weight, donor_bp, donor_eligibility, donor_medication, donor_contact, donor_img_path)  
    VALUES ('$user_id', '$name', '$gender', '$age', '$bloodgroup', '$height', '$weight', '$bp', '$pastdonation', '$medication', '$contact', '$path')";
    $conn->exec($sql);
    }
...
<body>
  <div class="wrapper">
          ...
          <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav pull-right">
                ...
                <li class="dropdown">
                  <a href="benefits.php">Donation Benefits</a>
   ...
   <input type="textarea" name="medication" value="<?php echo $medication;?>">
                ...
                <div class="controls controls-row">
                  <div class="control-group span6">
                    Have You donated blood within last eight weeks?:
   <input type="radio" name="pastdonation" <?php if (isset($pastdonation) && $pastdonation=="true") echo "checked";?>  value="true">Yes
   <input type="radio" name="pastdonation" <?php if (isset($pastdonation) && $pastdonation=="False") echo "checked";?>  value="false">No
   <span class="error">* <?php echo $pastdonationErr;?>
                  </div>
                </div>
                <br></br>
                <div class="controls controls-row">
                ...
                <div class="controls controls-row">
                  <div class="control-group span12">
                    Disease listing:
                                   <input type="checkbox" name="acute_infection" value="acute_infection">Acute Infection
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="asthma" value="asthma">Asthma
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="hypertension" value="hypertension">hypertension
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="chronic_illnesses" value="chronic_illnesses">Chronic Illnesses
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="cjd" value="cjd">Creutzfeldt-Jakob Disease (CJD)
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="diabetics" value="diabetics">Diabetics
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="hemochromatosis" value="hemochromatosis">Hemochromatosis (Hereditary)
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="hepatities" value="hepatities">Hepatitis, Jaundice
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="aids" value="aids">HIV, AIDS
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="malaria" value="malaria">Malaria
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="std" value="std">Sexually Transmitted Disease (STD)
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="tuberculosis" value="tuberculosis">Tuberculosis
                  </div>
                </div>
