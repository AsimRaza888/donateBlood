   ...
   <!-- Page Header -->
              ...
              <ul class="nav pull-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="profile.php">Blood Qunatity</a>
                    </li>
                    <li>
    ...
    <div id="content" role="main">
      ...
      <section class="section section-alt section-padded">
        ...
        $dinfo = "SELECT * FROM blood_quantity,bloodbank where bloodbank.bloodbank_id = blood_quantity.bloodbank_id";
...
if ($dresult->num_rows > 0) {
    ...
    while($row = $dresult->fetch_assoc()) {
        ...
        echo "<tr>";
        echo "<td rowspan=\"8\"> " .$row["bloodbank_name"]. "</td>";
        echo "<td>A+</td>";
        echo "<td> " .$row["A+"]. "</td>";
        echo "</tr>";
        echo "<tr>";
